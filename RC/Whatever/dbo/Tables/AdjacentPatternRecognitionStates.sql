CREATE TABLE [dbo].[AdjacentPatternRecognitionStates] (
    ...
    CONSTRAINT [FK_AdjacentPatternRecognitionStates_Patterns] FOREIGN KEY ([PatternId]) REFERENCES [dbo].[Patterns] ([PatternId])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_AdjacentPatternRecognitionStates]
    ON [dbo].[AdjacentPatternRecognitionStates]([PatternId] ASC, [PatternAdjacentTypeId] ASC, [Color] ASC) WITH (FILLFACTOR = 60, STATISTICS_NORECOMPUTE = ON);
