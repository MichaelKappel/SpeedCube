CREATE TABLE [dbo].[FacePatternRecognitionStates] (
    ...
    CONSTRAINT [FK_FacePatternRecognitionStates_Patterns] FOREIGN KEY ([PatternId]) REFERENCES [dbo].[Patterns] ([PatternId])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_FacePatternRecognitionStates]
    ON [dbo].[FacePatternRecognitionStates]([PatternId] ASC, [PatternFaceTypeId] ASC, [Color] ASC) WITH (FILLFACTOR = 60, STATISTICS_NORECOMPUTE = ON);
