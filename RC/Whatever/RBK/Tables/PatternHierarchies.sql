CREATE TABLE [RBK].[PatternHierarchies] (
    ...
    CONSTRAINT [PK_PatternHierarchies] PRIMARY KEY NONCLUSTERED ([PatternHierarchyHid] ASC) WITH (FILLFACTOR = 40, STATISTICS_NORECOMPUTE = ON),
...
GO
CREATE NONCLUSTERED INDEX [IX_PatternHierarchies_RelationId]
    ON [RBK].[PatternHierarchies]([PatternRelationId] ASC) WITH (FILLFACTOR = 40, STATISTICS_NORECOMPUTE = ON);
